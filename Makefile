...
benchmarks-3.8:
	...
	python -m locust -f profiler/locustfile.py --headless -u 4 -r 5 --run-time 60 --csv results_3.8 --host http://127.0.0.1:8000
...
benchmarks-3.9:
	...
	python -m locust -f profiler/locustfile.py --headless -u 4 -r 5 --run-time 60 --csv results_3.9 --host http://127.0.0.1:8000
...
benchmarks-3.10:
	...
	python -m locust -f profiler/locustfile.py --headless -u 4 -r 5 --run-time 60 --csv results_3.10 --host http://127.0.0.1:8000
...
benchmarks-3.11:
	...
	python -m locust -f profiler/locustfile.py --headless -u 4 -r 5 --run-time 60 --csv results_3.11 --host http://127.0.0.1:8000
